...
**DClaw Test** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8028` (FastAPI)
- **Frontend Port:** `3028` (Next.js)
- **Database:** `dclaw_test` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3028`
